...
class RecorderThread extends Thread {
    ...
    RecorderThread(FFmpegFrameRecorder videoRecorder, int previewWidth, int previewHeight) {
        try {
            this.previewWidth = previewWidth;
            this.previewHeight = previewHeight;
            savedFrameList = new ArrayList<>();
    ...
    void putByteData(SavedFrames lastSavedframe) {
