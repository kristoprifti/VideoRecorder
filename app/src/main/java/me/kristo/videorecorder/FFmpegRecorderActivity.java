...
import me.kristo.videorecorder.interfaces.Interfaces;
import me.kristo.videorecorder.util.CustomUtil;
...
public class FFmpegRecorderActivity extends Activity implements OnClickListener, OnTouchListener, Interfaces.AddBitmapOverlayListener {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        return initSuccess && super.dispatchTouchEvent(ev);
    }
    ...
    private void initLayout() {
        ...
        Button cancelBtn = (Button) findViewById(R.id.recorder_cancel);
    ...
    private void initVideoRecorder() {
        ...
        int currentResolution = CONSTANTS.RESOLUTION_MEDIUM_VALUE;
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.recorder_next) {
            ...
            isFrontCam = (cameraSelection != CameraInfo.CAMERA_FACING_BACK);
    ...
    private class DeviceOrientationEventListener
        ...
        DeviceOrientationEventListener(Context context) {
            super(context);
        }
